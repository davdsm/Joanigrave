      ...
      <div class="mx-auto">
        ...
        >
          <div>
            ...
            <h3 class="mb-2 text-xl font-bold dark:text-white">Quadros</h3>
            <p class="text-gray-500 dark:text-gray-400">
              Produção e comercialização de quadros para estamparia/serigrafia
              em ferro galvanizado ou alumínio (perfil 25x25mm, 30x30mm e
              40x40mm e outras medidas por encomenda).
            </p>
          </div>
          <div>
            <div
            ...
            <h3 class="mb-2 text-xl font-bold dark:text-white">Telas</h3>
            <p class="text-gray-500 dark:text-gray-400">
              Aplicação de telas (da tela 7T até à tela 200T) em quadros com
              cola de dois componentes de alta resistência a solventes, químicos
              e água (para a indústria da impressão serigráfica/estamparia para
              tintas à base de água e solventes, colas e glitters).
            </p>
          </div>
          <div>
            <div
            ...
            <p class="text-gray-500 dark:text-gray-400">
              Recuperação de quadros, recolocação de telas e gravação direta em
              quadros de grande formato com a Tecnologia CTS.
            </p>
          </div>
          <div>
            <div
            ...
            <h3 class="mb-2 text-xl font-bold dark:text-white">Produção</h3>
            <p class="text-gray-500 dark:text-gray-400">
              Produção e gravação de quadros para a estamparia localizada e
              estamparia a metro.
            </p>
          </div>
          <div>
